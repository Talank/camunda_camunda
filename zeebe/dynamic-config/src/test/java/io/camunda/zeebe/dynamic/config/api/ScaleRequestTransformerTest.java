...
class ScaleRequestTransformerTest {
  ...
  void shouldFailIfClusterSizeLessThanReplicationFactor(
    ...
    final var operationsEither =
        new ScaleRequestTransformer(distributor, newMembers).operations(oldClusterTopology);
  ...
  void shouldScaleAndReassign(
    ...
    final var operations =
        new ScaleRequestTransformer(distributor, newMembers).operations(oldClusterTopology).get();
